<template>
  <router-view>
    ...
    <HowItWorksAccordion v-model="activePanels" @accordion-opened="handleAccordionOpened"
      ...
      <info-card class="flex-grow-1" title="Step 2" image-src="/TechTrove-Web-Vue-V1/images/tech-entry-4.png"
        description="Click on a product card for more details. Add products to your cart, and customize your order."></info-card>

      <info-card class="flex-grow-1" title="Step 3" image-src="/TechTrove-Web-Vue-V1/images/tech-entry-5.png"
    ...
    <HowItWorksAccordion @accordion-opened="handleAccordionOpened"
      ...
      <info-card class="flex-grow" title="As a Supplier" image-src="/TechTrove-Web-Vue-V1/images/tech-entry-7.png"
        description="TechTrove is a community-driven platform that helps you find the best deals and quality products for every build. As a supplier, you can create a vendor profile to showcase your products and services. Reach out to customers directly and gain new business opportunities."></info-card>
      <info-card class="flex-grow" title="As a Colleague" image-src="/TechTrove-Web-Vue-V1/images/tech-entry-7.png"
        description="Join a team of experts dedicated to providing the best parts and service."></info-card>
